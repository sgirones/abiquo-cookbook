  ...
  :abiquo => {
    :properties => {
      ...
      :rs => {
        ...
        "abiquo.virtualfactory.vmware.repositoryLocation" => "10.10.10.1:/volume1/mothership-nfs",
        "abiquo.storagemanager.netapp.user" => "user",
        "abiquo.virtualfactory.hyperv.repositoryLocation" => "10.10.10.1:/volume1/mothership-nfs",
        "abiquo.appliancemanager.repositoryLocation" => "10.10.10.1:/volume1/mothership-nfs",
